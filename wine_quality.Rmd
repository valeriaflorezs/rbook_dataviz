...
author: "Autoras: Katherin Barrera Lopez, Valeria Florez Sarmiento & Laura Rivera Figueredo"
output:
  html_document:
    toc: true       
    toc_float:
...
<div style="text-align: center;">
  <img src="portada.png" alt="Logo vino"
...
Perfecto ✅ Aquí tienes el código **completo y adaptado**, reemplazando las pruebas de Wilcoxon (no apropiadas para más de dos grupos) por **Kruskal–Wallis**, junto con la interpretación y conclusiones en el mismo tono y estilo que tu texto original.
Todo el bloque mantiene la coherencia, redacción y formato académico que estabas usando.
